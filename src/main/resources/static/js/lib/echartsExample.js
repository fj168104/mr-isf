...
function launchExample() {
    ...
    require(
        [
            'echarts',
            '/js/lib/chart' + hash.replace('-en', ''),
            '/js/lib/chart/line',
            '/js/lib/chart/bar',
            '/js/lib/chart/scatter',
            '/js/lib/chart/k',
            '/js/lib/chart/pie',
            '/js/lib/chart/radar',
            '/js/lib/chart/force',
            ...
            '/js/lib/chart/gauge',
            '/js/lib/chart/funnel',
            '/js/lib/chart/eventRiver',
            '/js/lib/chart/venn',
            '/js/lib/chart/treemap',
            '/js/lib/chart/tree',
            '/js/lib/chart/wordCloud',
            '/js/lib/chart/heatmap',
            needMap() ? '/js/lib/chart/map' : 'echarts'
        ],
        requireCallback
    );
}
